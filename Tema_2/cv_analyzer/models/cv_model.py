...
class HabilidadClave(BaseModel):
    """Una habilidad técnica relevante para el puesto y si el candidato la posee."""

    nombre: str = Field(description="Nombre de la habilidad técnica relevante para el puesto.")
    presente: bool = Field(description="True si el candidato demuestra esta habilidad en su CV; False si NO la tiene.")
...
class AnalisisCV(BaseModel):
    ...
    habilidades_clave: list[HabilidadClave] = Field(description="Lista de las 5-7 habilidades técnicas clave requeridas por el puesto, indicando para cada una si el candidato la posee o no.")
